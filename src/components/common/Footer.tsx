...
const SocialIcons = () => (
    <div className="flex items-center text-base gap-5">
        <a href="#" aria-label="X" className="text-white hover:text-white transition-colors">
            <X className="w-6 h-6" />
            
        </a>
        <a href="#" aria-label="LinkedIn" className="text-white hover:text-white transition-colors">
        ...
        <a href="#" aria-label="Instagram" className="text-white hover:text-white transition-colors">
        ...
        <a href="#" aria-label="Facebook" className="text-white hover:text-white transition-colors">
...
const Footer = () => {
    return (
        ...
        >
            ...
            <div className="relative z-10 md:hidden max-w-2xl mx-auto px-4  py-32">
                <p className="text-5xl font-semibold  mb-10">Blockchain</p>

                <Accordion type="multiple">
                    {footerLinks.map((section) => (
                        <AccordionItem key={section.title} value={section.title}>
                            <AccordionTrigger className="text-base py-1  font-semibold">{section.title}</AccordionTrigger>
                            <AccordionContent>
                ...
                <div className="flex justify-center items-center px-20">
                    <img src={appleLogo} alt="App Store" className="w-40 h-30 object-contain" />
                    <img src={appleLogo} alt="App Store" className="w-40 h-30 object-contain" />

                    {/* <img src={playstoreLogo} alt="Google Play" className="w-45 h-50 bg-red object-contain" /> */}
                </div>
                ...
                <div className="flex flex-col text-base gap-3 mb-6">
                    <div className="flex items-center gap-5 text-white/60 ">
                        <Globe size={24} className="  text-white" /><span>English</span>
                    </div>
                    <div className="flex items-center gap-5 text-white/60 ">
                        <CircleDollarSign size={24} className="text-white" /><span>Blockchain.com</span>
                    </div>
                </div>
            ...
            <div className="relative z-10 hidden md:block max-w-6xl mx-auto px-8 md:px-10 lg:px-16 py-32">

                {/* Top row: Blockchain | line | social icons */}
                <div className="flex items-center mb-10 md:mb-3">
                    <p className="text-[44px] lg:text-5xl font-semibold whitespace-nowrap">Blockchain</p>
                    <div className="flex-1 border-t border-white/90 mx-4 lg:mx-6" />
                    <SocialIcons />
                </div>
                ...
                <div className="grid grid-cols-5 gap-4 lg:gap-8 mb-10 lg:mb-14">
                    ...
                    <div className="col-span-1 flex flex-col items-start gap-3">
                        <div className="bg-white rounded-lg  w-20 h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 flex items-center justify-center">
